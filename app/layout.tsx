...
export const metadata: Metadata = {
  metadataBase: new URL(RXL_SITE.productionUrl),
  title: { default: RXL_SITE.name, template: `%s | ${RXL_SITE.name}` },
  description: RXL_SITE.description,
  alternates: { canonical: RXL_SITE.productionUrl },
  openGraph: {
    title: RXL_SITE.name,
    description: RXL_SITE.description,
    url: RXL_SITE.productionUrl,
    siteName: RXL_SITE.name,
    type: "website",
  },
  twitter: { card: "summary", title: RXL_SITE.name, description: RXL_SITE.description },
};
